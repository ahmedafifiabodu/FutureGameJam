...
namespace ProceduralGeneration.Editor
{
    public class ProceduralSetupWizard : EditorWindow
    {
        ...
        {
            GameObject roomObj = new("StartingRoom");
            ...
            GameObject exitPoint = new("ExitPoint");
            exitPoint.transform.parent = roomObj.transform;
            exitPoint.transform.SetLocalPositionAndRotation(new Vector3(0f, 1f, 5f), Quaternion.Euler(0f, 0f, 0f));
        ...
        private void CreateSquareRoom(string name, float size, float _)
        {
            GameObject roomObj = new(name);
        ...
        private void CreateLargeRoom(string name, float size, float _)
        {
            GameObject roomObj = new(name);
            roomObj.AddComponent<Room>();
        ...
        {
            GameObject corridorObj = new(name);
            corridorObj.AddComponent<Corridor>();
        ...
        private void CreateAlcove(Transform parent, Vector3 position, float depth, float width, float height, Quaternion rotation)
        {
            ...
            alcove.transform.SetLocalPositionAndRotation(position, rotation);
        ...
        private void CreateOctagonalWalls(Transform parent, float radius, float height)
        {
            ...
            for (int i = 0; i < sides; i++)
            {
                ...
                Vector3 pos1 = new(Mathf.Cos(angle) * radius, height / 2f, Mathf.Sin(angle) * radius);
                Vector3 pos2 = new(Mathf.Cos(nextAngle) * radius, height / 2f, Mathf.Sin(nextAngle) * radius);
                ...
                wall.transform.SetLocalPositionAndRotation(wallPos, Quaternion.Euler(0f, wallAngle - 90f, 0f));
        ...
        private void CreateRoomConnectionPoints(Transform parent, float depth)
        {
            ...
            GameObject entrancePoint = new("EntrancePoint");
            entrancePoint.transform.parent = parent;
            entrancePoint.transform.SetLocalPositionAndRotation(new Vector3(0f, 1f, -depth / 2f), Quaternion.Euler(0f, 180f, 0f));
            entrancePoint.AddComponent<ConnectionPoint>();

            // Create exit point (Point B)
            GameObject exitPoint = new("ExitPoint");
            exitPoint.transform.parent = parent;
            exitPoint.transform.SetLocalPositionAndRotation(new Vector3(0f, 1f, depth / 2f), Quaternion.Euler(0f, 0f, 0f));
            exitPoint.AddComponent<ConnectionPoint>();
        }
        ...
        private void CreateCorridorConnectionPoints(Transform parent, float length)
        {
            ...
            GameObject entrancePoint = new("EntrancePoint");
            entrancePoint.transform.parent = parent;
            entrancePoint.transform.SetLocalPositionAndRotation(new Vector3(0f, 1f, -length / 2f), Quaternion.Euler(0f, 180f, 0f));
            entrancePoint.AddComponent<ConnectionPoint>();

            // Create exit point (Point B)
            GameObject exitPoint = new("ExitPoint");
            exitPoint.transform.parent = parent;
            exitPoint.transform.SetLocalPositionAndRotation(new Vector3(0f, 1f, length / 2f), Quaternion.Euler(0f, 0f, 0f));
            exitPoint.AddComponent<ConnectionPoint>();
        }
        ...
        private void CreateGeneratorInScene()
        {
            ...
            ProceduralLevelGenerator existing = FindFirstObjectByType<ProceduralLevelGenerator>();
            if (existing != null)
            {
            ...
            // Create generator
            GameObject generatorObj = new("ProceduralLevelGenerator");
            generatorObj.AddComponent<ProceduralLevelGenerator>();
